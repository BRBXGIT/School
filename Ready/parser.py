...
#Функция парсинга и сохранения в разные форматы файлов  
@eel.expose                                
def parse(searching_list, save_mode):
    try:
        eel.start_finish_parsing_msg('Парсинг начат')
...
if __name__ == '__main__':
    ...
    eel.start('main.html', size=(850, 1000), port=0)