...
def save_file_txt(find_items, items_for_delete, find_links):
    ...
    dir = os.mkdir(f'{searching_list[0]}_txt')
    
    abs_file_path = os.path.abspath(f'{searching_list[0]}_txt')
...
def save_file_csv(find_items, items_for_delete, find_links):
    ...
    dir = os.mkdir(f'{searching_list[0]}_csv')
    
    abs_file_path = os.path.abspath(f'{searching_list[0]}_csv')           
